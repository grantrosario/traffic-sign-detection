...
def LeNet(x):
    ...
    # Layer 2: Convolutional. Input = 32x32x8. Output = 32x32x16.
    ...
    # Layer 6: Fully Connected. Input = 512. Output = 2.
    fc3_W  = tf.Variable(tf.truncated_normal(shape=(512,2), mean = mu, stddev = sigma))
